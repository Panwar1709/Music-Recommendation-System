    ...
    <header>
        <div class="menu_side">
            ...
            <div class="menu_song">
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="img/arjit/6.jpg" alt="">
                    <h5>Phir Aur Kya Chahiye <br>
                        <div class="subtitle">Arijit Singh</div>
                    </h5>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Arijit Singh-Khairiyat</h1>
                <p>Khairiyat Puchon Kabhi To Kaifiyat Puchon
                    Tumhare Bin Deewane Ka<br>
                    Kya Haal Hai
                    Dil Mera Dekho
                    Na Meri Haisiyat Puchon<br>
        ...
        <div class="master_play">
            ...
            <img class="master_play_image"  src="img/arjit/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">
                Naina ashq na ho 
                <div class="subtitle">Arijit Singh</div>
            </h5>
