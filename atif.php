...
<body style="background-image: url('L6.jpg'); background-size: cover; background-repeat: no-repeat; ">
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Atif Aslam-Baarishein</h1>
                <p>Baarishein Yu Achanak Hui
        ...
        <div class="master_play">
            ...
            <img class="master_play_image"  src="img/atif/1.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Darasal
