...
<body style="background-image: url('L6.jpg'); background-size: cover; background-repeat: no-repeat; ">
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Neha Kakkar-Baarishein</h1>
                <p>Ashiq banaaya ashiq banaaya
                Ashiq banaaya aapane <br>
                Tere bin suuni-suuni hain baahen
                Tere bin pyaasi-pyaasi<br> nigaahen
                Tere bin bin asar meri aahen
                Tere bin
                   </p>
                <div class="buttons">
                    <button>Play</button>
        ...
        <div class="master_play">
            ...
            <img class="master_play_image"  src="img/neha/1.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
            Aashiq Banaya Aapne
                <div class="subtitle">Neha Kakkar</div>
            </h5>
