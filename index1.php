    ...
    <header>
        <div class="menu_side">
            ...
            <div class="playlist">
                ...
                <h4><span></span><i class="bi bi-music-note-beamed"></i><a href="recommend.php" style="color: inherit; text-decoration: none;">Recommended for you</a></i></h4>
            </div>
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>You were the shadow to my light
                    Did you feel us? Another start
                    you fade
                    <br> Away afraid our aim is out of sight
                    Wanna see us, alive
                    Where are you now?
                   </p>
                <div class="buttons">
        ...
        <div class="master_play">
            ...
            <img class="master_play_image"  src="img/1.jpg" alt="" id="poster_master_play">
            <h5 id="title">
                On My Way
